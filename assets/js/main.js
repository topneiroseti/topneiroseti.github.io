...
(function(){
  ...
  var services=[
    ...
    {name:'STIVA.ai',cat:'Агрегатор',url:'aggregators/stiva-ai/'},
    {name:'Runway',cat:'Видео',url:'models/runway/'},
    {name:'Pika',cat:'Видео',url:'models/pika/'},
    {name:'Luma AI',cat:'Видео',url:'models/lumaai/'},
    {name:'Leonardo',cat:'Изображения',url:'models/leonardo/'},
    {name:'Ideogram',cat:'Изображения',url:'models/ideogram/'},
    {name:'ElevenLabs',cat:'Аудио',url:'models/elevenlabs/'},
    {name:'HeyGen',cat:'Видео',url:'models/heygen/'},
    {name:'Synthesia',cat:'Видео',url:'models/synthesia/'},
    {name:'Adobe Firefly',cat:'Изображения',url:'models/adobe/'},
    {name:'Stability AI',cat:'Изображения',url:'models/stability/'},
    {name:'Perplexity',cat:'Текст',url:'models/perplexity/'},
    {name:'Grok',cat:'Текст',url:'models/xai/'},
    {name:'Cohere',cat:'Текст',url:'models/cohere/'},
    {name:'NVIDIA Nemotron',cat:'Текст',url:'models/nvidia/'},
    {name:'Google Gemini',cat:'Текст',url:'models/google/'},
    {name:'Qwen',cat:'Текст',url:'models/alibaba/'},
    {name:'GLM',cat:'Текст',url:'models/zhipu/'},
    {name:'Luma',cat:'Видео',url:'models/lumaai/'}
